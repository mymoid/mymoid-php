...
trait MymoidParser
{
     ...
     * @throws \InvalidArgumentException
     */
    public function parseFromArray($content)
    {
     ...
     * @throws \InvalidArgumentException
     */
    private function setValue($key, $value, $obj = null)
    {
     ...
     */
    private function parseErrors($errors, $is_legacy = false)
    {
        $error_details = [];
     ...
     * @return PaymentPoint
     */
    private function parsePaymentPoint($payment_point)
    {
     ...
     */
    private function parsePaymentMethodDetails($payment_method_details)
    {
     ...
     */
    private function parsePaymentMethodDetail($payment_method_detail)
    {
     ...
     * @return Bines
     */
    private function parseBines($bines)
    {
     ...
     */
    private function parsePaymentMethod($payment_method)
    {
     ...
     * @return PaymentOrder
     */
    private function parsePaymentOrder($payment_order)
    {
     ...
     * @return array
     */
    private function getObjectProperties($object_class)
    {
        $result = [];

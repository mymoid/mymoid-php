...
class GetPaymentOrdersDetail extends MymoidRequest
{
    protected string $endpoint = '/payment-orders/{id}';
    ...
    public function __construct(
        ...
        $this->setPathParam('id', $payment_id);
